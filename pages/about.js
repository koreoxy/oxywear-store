    ...
    <Layout title="About Us">
      <div className="text-center font-bold p-5">
        <h1 className="text-[21px]">
          About <span className="text-green-500">OxyWear </span>Store
        </h1>
      ...
      <div className="sm:px-20 pb-10">
        ...
        <p>
          ...
          nisl. Aenean gravida turpis nisi, consequat dictum risus dapibus a.
          Duis felis ante, varius in neque eu, tempor suscipit sem. Maecenas
