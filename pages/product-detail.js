        ...
        <div className="flex flex-col">
          ...
          <div className="pt-5">
            ...
            <div className="flex flex-row">
              ...
              <div className="bg-gray-400 rounded-full w-7 h-7">
                <button onClick={incrementCount} className="pl-[5px] pt-[5px]">
                  <BiPlus />
                </button>
              </div>
            </div>
            ...
            <div class="flex">
              <div class="flex-none w-[450px] max-sm:w-[330px]">
                <p>
                  ...
                  Class aptent taciti sociosqu ad litora torquent perconubia
                  nostra, per inceptos himenaeos. Curabitur tempus urna at
                  turpis condim entumlobortis. Ut commodo efficitur neque. Ut
                  diam quam, semper iaculis condimen tum ac, vestibulum eu nisl.
                </p>
              </div>
            </div>
          </div>
